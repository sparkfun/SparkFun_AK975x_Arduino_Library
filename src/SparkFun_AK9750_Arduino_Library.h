...
class AK9750 {
  public:
    ...
    void setMode(uint8_t mode = AK9750_MODE_0); //Set mode of the sensor. Mode 0 is continuous read mode
    void setCutoffFrequency(uint8_t frequency = AK9750_FREQ_8_8HZ); //Filtering freq. 8Hz is fastest, least filtered
